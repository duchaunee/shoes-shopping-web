...
const Header = ({
      ...
      if (user) {
        ...
        localStorage.setItem(
          ...
          user.displayName?.slice(0, 20) ||
            user.email.slice(0, -10).charAt(0).toUpperCase() +
              user.email.slice(0, -10).slice(1)
        );
  ...
  return (
    <>
      ...
      <div
        className={`${scrolled ? "" : "absolute"} z-[99999] h-[125px] w-full`}
      ></div>
      <header
        className={`${
          scrolled ? "stuck fixed" : "relative"
        } z-[99999] h-[125px] w-full text-white/80`}
      >
          ...
          <div className=" grid grid-cols-12 grid-rows-1 h-full px-[15px] max-w-[1230px]  mx-auto">
                ...
                >
                  ...
                  {hoverAccount ? (
                    <DropDownAccount
                      ...
                      setHoverAccount={setHoverAccount}
                      admin={admin}
                    />
                  ) : (
                    ""
            ...
            <div className="col-span-4 ml-auto flex gap-[15px] items-center">
              ...
              >
                ...
                />
                {hoverSearch && (
                  <DropDownSearch setHoverSearch={setHoverSearch} />
                )}
              </div>
              {admin ? (
                <NavLink
