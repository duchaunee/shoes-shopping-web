...
const EmplyPage = ({ children: text, className }) => {
  return (
    <div className="w-full py-[200px] bg-gray-100 flex items-center justify-center">
      <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div className="max-w-md">
          <div className={`text-5xl font-dark font-bold ${className}`}>
            {text}
          </div>
          <p className="text-2xl my-4 md:text-3xl font-light tracking-wide">
            Sorry we're developing this page
          </p>
