  ...
  const checkInvalidUser = (e) => {
    ...
    //Điền cả 3 ô, phải check điều kiện từng ô một
      ...
      if (!/^[a-zA-Z0-9]{8,}$/.test(infoChange.newPassword)) {
        return {
          notify:
            "Mật khẩu mới phải dài ít nhất 8 ký tự và không chứa các ký tự đặc biệt",
          status: false,
          changePass: false,
        };
      }
    ...
    return new Promise((resolve, reject) => {
      ...
      if (haveChangeImg) {
        const storageRef = ref(
          storage,
          `shoesPlus-avatar/${Date.now()}${fileImg.name}`
        );
        ...
        allReviews.map(async (review) => {
          try {
            await setDoc(doc(db, "reviews", review.id), {
              ...
              imgAvatar:
                localStorage.getItem("imgAvatar") || currentUser?.photoURL,
    ...
    <>
      <div className="my-[30px] max-w-[1230px] mx-auto">
        <div className="px-[15px]">
          <div className="mb-4">
            <span className="text-[#353535] block text-[16px] font-bold uppercase ">
            ...
            <div
              ...
              className={`${
                showVouchers || "h-0 opacity-0"
              } transition-all ease-linear duration-200 mt-4`}
            >
          ...
          <form onSubmit={handleSubmit}>
            <div className="w-full mb-12 text-[#222] text-[14px] flex flex-col gap-5 ">
              ...
              <div className="">
                ...
                <UploadSquare
                  ...
                  srcURL={
                    src.imgAvatar ||
                    localStorage.getItem("imgAvatar") ||
                  ...
                  width="w-[222px]"
                />
                <span className="block mt-2 text-[#353535] text-[16px] italic">
                  Ảnh sẽ được tự động cắt theo hình tròn khi tải lên
                </span>
              </div>
              <p>
                <label
                ...
                <input
                  ...
                  type="text"
                />
                <span className="text-[#353535] text-[16px] italic">
                  Đây sẽ là cách mà tên của bạn sẽ được hiển thị trong phần tài
                  khoản và trong phần đánh giá
                </span>
              </p>
              ...
              <p>
                ...
                <input
                  ...
                  autoComplete="off"
                  placeholder={
                    displayEmail || localStorage.getItem("displayEmail") || ""
                  }
                  className="align-middle pointer-events-none bg-white shadow-sm text-[#222] w-full h-10 outline-none border border-solid border-[#ddd] text-[16px] px-3 mb-2"
                  type="text"
                />
                <span className="text-[#353535] text-[16px] italic">
            ...
            {isGoogleUser ? (
              <div className="w-full text-[#222] text-[14px] flex flex-col gap-5">
                ...
                <span className="text-[#353535] text-[16px] italic">
                  Bạn không thể thay đổi mật khẩu do đang đăng nhập bằng tài
                  khoản Google
                </span>
              </div>
            ) : (
              <div className="w-full text-[#222] text-[14px] flex flex-col gap-5">
                ...
                <p>
                  <label className="mb-2 font-bold block" htmlFor="password_1">
                    Mật khẩu mới
                  </label>
                  <input
                ...
                <p>
                  <label className="mb-2 font-bold block" htmlFor="password_2">
